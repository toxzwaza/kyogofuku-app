                    ...
                    <form @submit.prevent="submit">
                        ...
                        <section class="pt-6 border-t border-brand-border">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-brand-text mb-1">残業・端数の切り捨て上限（分）</label>
                                    <input
                                        ...
                                        class="w-full rounded-md border-brand-border shadow-sm"
                                    />
                                    <p class="mt-1 text-xs text-brand-text-muted">丸め単位未満の端数のうち、この値以下は捨て、超えると次の単位へ切り上げ（例: 単位30・上限15 → 44分→30分、46分→60分）</p>
