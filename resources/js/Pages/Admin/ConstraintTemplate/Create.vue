    ...
    <AdminLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-brand-text leading-tight">制約追加</h2>
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="border-t border-brand-border pt-6">
                                        ...
                                        <button
                                            ...
                                            class="inline-flex items-center gap-2 text-sm text-brand-primary hover:text-brand-primary-hover font-medium mb-4 disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
