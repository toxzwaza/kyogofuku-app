    ...
    <AdminLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-brand-text leading-tight">スタッフ編集</h2>
                <Link
                    ...
                    <div class="p-6">
                        <form @submit.prevent="submit">
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-brand-text mb-1">パスワード</label>
                                    <input
                                        v-model="form.password"
                                        type="password"
                                        class="w-full rounded-md border-brand-border shadow-sm focus:border-brand-primary focus:ring-brand-primary"
                                    />
                                    <p class="mt-1 text-sm text-brand-text-muted">変更しない場合は空欄のままにしてください</p>
                                    <div v-if="form.errors.password" class="mt-1 text-sm text-red-600">{{ form.errors.password }}</div>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-brand-text mb-1">パスワード（確認）</label>
                                    <input
