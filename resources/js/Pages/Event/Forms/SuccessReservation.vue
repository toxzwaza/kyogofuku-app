<template>
    <div class="max-w-4xl mx-auto p-6 text-center">
        <div class="bg-white rounded-lg shadow-lg p-8 mb-6">
            ...
            <h2 class="text-3xl font-bold text-gray-900 mb-4">予約が完了しました</h2>
            <p class="text-gray-700 mb-6">
                ご予約ありがとうございます。<br>
                予約内容を確認の上、ご来店をお待ちしております。
            </p>
            <div class="bg-gray-50 rounded-lg p-6 mb-6 text-left">
                <h3 class="text-lg font-semibold mb-4 text-gray-900">予約内容</h3>
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        <span class="text-gray-600">予約日時:</span>
                        <span class="text-gray-900 font-medium">{{ formatDateTime(formData.reservation_datetime) }}</span>
                    </div>
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="text-gray-900 font-medium">{{ formData.phone }}</span>
                    </div>
                </div>
            </div>
            <button
